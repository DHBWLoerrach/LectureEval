import {
  defineMessages as baseDefineMessages,
  MessageDescriptor,
} from 'react-intl';
 ...
 */
const defineMessages = <T extends MessageRecord<keyof T & string>>(
  messages: T
) => {
...
export const translations = defineMessages({
  ...
  saveFormDescription: {
    defaultMessage:
      'Nach dem Absenden können keine Änderungen mehr gemacht werden.',
  },
  formSaved: {
